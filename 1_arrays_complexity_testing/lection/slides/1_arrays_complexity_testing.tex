...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Поиск в массиве, Источник - \href{https://www.geeksforgeeks.org/linear-search/}{GeeksForGeeks}}]{\includegraphics[width=60mm, height=50mm]{array_search}}
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Многомерные массивы, Источник - неизвестен}]{\includegraphics[width=90mm, height=50mm]{array_rowcolumn}} 
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Источник - \href{https://en.wikipedia.org/wiki/Dynamic_array}{Wikipedia}}]{\includegraphics[width=40mm, height=39mm]{array_dynamic}} 
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Пример динамического массива, Источник - \href{https://sassafras13.github.io/images/2021-01-16-DynamicResizeLists-fig1.png}{Link}}]{\includegraphics[width=100mm, height=65mm]{array_dynamic_example}} 
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Вычислительная сложность операций на массивах}]{\includegraphics[width=90mm, height=50mm]{array_complexity_table2}} 
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Достоинства и недостатки массивов}]{\includegraphics[width=140mm, height=50mm]{array_pros_cons}} 
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Источник - Dasgupta, Papadimitriu, Vazirani}]{\includegraphics[width=65mm, height=48mm]{elementary_ops}} 
\end{figure}
\end{frame}	
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Источник - Dasgupta, Papadimitriu, Vazirani}]{\includegraphics[width=60mm, height=45mm]{bigo_test}} 
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Источник - \href{https://habr.com/ru/articles/188010/}{Хабр}}]{\includegraphics[width=90mm, height=45mm]{small_o}}     
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Источник - Dasgupta, Papadimitriu, Vazirani}]{\includegraphics[width=100mm, height=45mm]{bigo_rules}} 
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Источник - указать}]{\includegraphics[width=100mm, height=60mm]{bigo_complexity_chart}}     
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Источник - указать}]{\includegraphics[width=120mm, height=45mm]{complexity_table}}     
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Источник - указать}]{\includegraphics[width=35mm, height=30mm]{testing_statement}} 
\end{figure}
\end{frame}
