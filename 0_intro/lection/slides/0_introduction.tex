...
\graphicspath{{/home/llyy/Yandex.Disk/personal/knowledge/general/algorithms_course/repo/algorithms_course/0_intro/lection/images}}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize \quad Пример двоичного кода}]{\includegraphics[width=40mm, height=20mm]{binary_hw}} 
    \subfigure[{ \scriptsize \quad Пример hex кода}]{\includegraphics[width=40mm, height=20mm]{hex_hw}} 
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize \quad Пример кода на ASM}]{\includegraphics[width=70mm,height=25mm]{assembler_code_example}}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize \quad Пример кода на Паскале (ЯВУ)}]{\includegraphics[width=65mm, height=25mm]{pascal_code_example}} 
...
\includegraphics[width=40mm, height=60mm]{compiler_code_stage}
\centering
...
\includegraphics[width=40mm, height=60mm]{interpreter_code_stage}
\centering
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize \quad После компиляции}]{\includegraphics[width=55mm, height=55mm]{compiler_run_stage}} 
    \subfigure[{ \scriptsize \quad После интерпретации}]{\includegraphics[width=50mm, height=55mm]{interpreter_run_stage}}
\end{figure}
\end{frame}
...
\small
\centering
\includegraphics[width=90mm, height=60mm]{cpp_how_compile}
...
\small
\centering
\includegraphics[width=130mm, height=60mm]{bit_byte_nibble_word}
...
\centering
\includegraphics[width=45mm, height=45mm]{hex_to_bin_conversion}
\centering

\column{40mm}

\includegraphics[width=30mm, height=60mm]{hex_digits}
\centering
...
\includegraphics[width=48mm, height=67mm]{memory_example}
\centering
...
\small
\centering
\includegraphics[width=80mm, height=68mm]{different_data_interpretation}
...
\includegraphics[width=140mm, height=30mm]{int_types_example}
\centering
...
\includegraphics[width=35mm, height=45mm]{int_types_mem_example}
\centering
...
\centering
\includegraphics[width=75mm, height=35mm]{unsigned_int_types}\newline
\centering
...
\centering
\includegraphics[width=70mm, height=20mm]{signed_magn_example}\newline
\centering
...
\centering
\includegraphics[width=80mm, height=65mm]{signed_all_table}
\centering

\column{60mm}

\includegraphics[width=35mm, height=65mm]{signed_16bit_example}
\centering
...
\small
\centering
\includegraphics[width=90mm, height=60mm]{signed_int_types}
...
\small
\centering
\includegraphics[width=110mm, height=70mm]{fp_conversions}
...
\small
\centering
\includegraphics[width=90mm, height=70mm]{ascii_table}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize \quad Конъюнкция (И/AND)}]{\includegraphics[width=45mm, height=50mm]{and_truth_table}} \quad\quad\quad
    \subfigure[{ \scriptsize \quad Дизъюнкция (ИЛИ/OR)}]{\includegraphics[width=45mm, height=50mm]{or_truth_table}} 
    \newline
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Исключающее ИЛИ/XOR}]{\includegraphics[width=45mm, height=50mm]{xor_truth_table}} \quad\quad\quad
    \subfigure[{ \scriptsize \quad Отрицание (НЕ/NOT)}]{\includegraphics[width=45mm, height=50mm]{not_truth_table}} 
    \newline
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Пример числовых литералов C/C++}]{\includegraphics[width=75mm, height=55mm]{literals_example}}    
...
\begin{figure}
    ...
    \centering
    \subfigure[{ \scriptsize Пример числовых литералов C/C++}]{\includegraphics[width=75mm, height=55mm]{literals_example}}
    \subfigure[{ \scriptsize \quad Результат примера}]{\includegraphics[width=55mm, height=30mm]{literals_example_result}}         
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Пример числовых литералов C/C++}]{\includegraphics[width=75mm, height=55mm]{bitwise_operator_example}}
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Пример битовых операции C/C++}]{\includegraphics[width=75mm, height=55mm]{bitwise_operator_example}}
    \subfigure[{ \scriptsize \quad Результат примера}]{\includegraphics[width=55mm, height=30mm]{bitwise_operator_example_result}}         
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Пример битовых масок}]{\includegraphics[width=70mm, height=50mm]{bitmask_simple}}
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Пример битовых масок}]{\includegraphics[width=65mm, height=50mm]{bitmask_simple}}
    \subfigure[{ \scriptsize \quad Результат примера}]{\includegraphics[width=55mm, height=30mm]{bitmask_simple_result}}         
\end{figure}
\end{frame}
...
\begin{figure}
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfigure[{ \scriptsize Пример битовых масок}]{\includegraphics[width=70mm, height=70mm]{bit_shift_example}}
\end{figure}
\end{frame}
...
\begin{figure}
    ...
    \centering
    \subfigure[{ \scriptsize Пример битовых масок}]{\includegraphics[width=70mm, height=70mm]{bit_shift_example}}
    \subfigure[{ \scriptsize \quad Результат примера}]{\includegraphics[width=45mm, height=60mm]{bit_shift_example_result}}         
\end{figure}
\end{frame}
